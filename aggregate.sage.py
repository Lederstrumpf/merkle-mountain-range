...
# This file was *autogenerated* from the file ./aggregate.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_1000 = Integer(1000); _sage_const_2 = Integer(2)#!/usr/bin/env sage
            ...
            for benchmark in BENCHMARK_NAMES:
                if line.startswith(benchmark):
                    ...
                    if match:
                        ...
                        # print(benchmark)
                        time_value = float(match.group(_sage_const_1 ))
                        # Convert µs to ns if necessary
                        if 'µs' in line:
                            time_value *= _sage_const_1000 
                        if benchmark:
...
for file in result_files:
    commit_hash = file.split('_')[_sage_const_2 ]
...
with open('final_results.json', 'w') as f:
    json.dump(final_results, f, indent=_sage_const_2 )
